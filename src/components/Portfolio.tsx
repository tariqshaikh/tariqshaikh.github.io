        ...
        <div className="hidden md:flex gap-5 items-stretch w-full max-w-[1400px] mx-auto">
          ...
          <div className="flex-1 min-w-0 bg-[#E2E2DF] rounded-2xl p-3 border border-slate-300/40">
            <div className="grid grid-cols-2 gap-3">
              ...
              {/* PM Prism */}
              <div className="min-h-[240px] 2xl:aspect-square bg-[#07091A] rounded-xl p-5 flex flex-col justify-between transition-all duration-300 hover:border-violet-500/50 hover:shadow-[0_16px_40px_-8px_rgba(139,92,246,0.25)] relative overflow-hidden group border border-white/5">
              ...
              {/* Homebase NJ */}
              <div className="min-h-[240px] 2xl:aspect-square bg-[#090E1A] rounded-xl p-5 flex flex-col justify-between transition-all duration-300 hover:border-blue-500/50 hover:shadow-[0_16px_40px_-8px_rgba(59,130,246,0.2)] relative overflow-hidden group border border-white/5">
              ...
              {/* Waves Travel Co */}
              <div className="min-h-[240px] 2xl:aspect-square bg-[#0B1A1F] rounded-xl p-5 flex flex-col justify-between transition-all duration-300 hover:border-cyan-500/50 hover:shadow-[0_16px_40px_-8px_rgba(6,182,212,0.2)] relative overflow-hidden group border border-white/5">
              ...
              {/* Orbit Capital */}
              <div className="min-h-[240px] 2xl:aspect-square bg-[#1A1C1E] rounded-xl p-5 flex flex-col justify-between transition-all duration-300 hover:border-[#C5A059]/50 hover:shadow-[0_16px_40px_-8px_rgba(197,160,89,0.2)] relative overflow-hidden group border border-white/5">
